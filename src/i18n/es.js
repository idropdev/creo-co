    ...
    items: [
      {
        ...
        industry: 'Desarrollo Económico',
        result:   '+340% consultas de inversores en 6 meses',
        desc:     'Reposicionamos un corredor de desarrollo binacional con una campaña bilingüe completa dirigida a inversores en ambos lados de la frontera.',
        tags:     ['Estrategia', 'Bilingüe', 'Campaña'],
      },
      {
        client:   'Organización Sin Fines de Lucro Fronteriza',
        industry: 'Sin Fines de Lucro',
        result:   '$2.1M recaudados en campaña anual',
        desc:     'Construimos un sistema de captación de donantes con contenido narrativo, secuencias de email y marketing de eventos que triplicaron las conversiones.',
        tags:     ['Recaudación', 'Contenido', 'Email'],
      },
      {
        client:   'Red de Salud Regional',
        industry: 'Salud',
        result:   '+58% nuevas citas de pacientes',
        desc:     'Lanzamos una campaña de concientización culturalmente adaptada en inglés y español, generando crecimiento medible en tres clínicas.',
        tags:     ['Bilingüe', 'Salud', 'Concientización'],
      },
    ],
  },
  borderplex: {
